...
def load(app):
    ...
    def create_study_session():
        ...
        try:
            ...
            cursor.execute('INSERT INTO study_sessions (name, description) VALUES (?, ?)', (data['name'], data['description']))
            app.db.commit()
            return jsonify({"session_id": cursor.lastrowid, "status": "created"}), 201
    ...
    # Endpoint: POST /api/study-sessions/reset
